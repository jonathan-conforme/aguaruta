...
<head>
    <meta charset="utf-8">
    <title>Restablecer Contraseña - AquaRutaTech</title>
</head>
<body style="font-family: Arial, sans-serif; background-color: #f4f6f8; padding: 20px; color: #333;">
    <div style="max-width: 600px; margin: 0 auto; background: #ffffff; padding: 30px; border-radius: 8px; border: 1px solid #e2e8f0;">
        ...
        <p>Recibiste este correo porque solicitaste restablecer la contraseña de tu cuenta en la plataforma de AquaRutaTech.</p>
        ...
        <p style="font-size: 11px; color: #94a3b8; text-align: center;">
            ...
            © {{ date('Y') }} AquaRutaTech Ecuador. Sin contrato de permanencia.
        </p>
    </div>
</body>
</html>
