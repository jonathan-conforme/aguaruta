...
// Agregamos las propiedades (props) que recibiremos desde Laravel: totalCompanies, totalAdmins, totalEmployees
export default function Dashboard({
    ...
    return (
        <AuthenticatedLayout
            user={auth.user}
            errors={errors}
            header={<h2 className="font-semibold text-xl text-gray-800 leading-tight">Panel de Control General</h2>}
        >
            ...
            <div className="py-8">
                <div className="mx-auto max-w-7xl sm:px-6 lg:px-8 space-y-6">
                    ...
                    {/* 📊 TARJETAS DE ESTADÍSTICAS DEL SAAS */}
                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5">
                        ...
                        <div className="bg-white rounded-2xl border border-slate-100 p-5 shadow-sm hover:shadow-md transition-shadow">
                            ...
                            <div className="flex items-baseline space-x-2 mt-3">
                                ...
                                <span className="text-xs text-slate-400">Purificadoras totales</span>
                            </div>
                        </div>
                        ...
                        <div className="bg-white rounded-2xl border border-slate-100 p-5 shadow-sm hover:shadow-md transition-shadow">
                            ...
                            <div className="flex items-baseline space-x-2 mt-3">
                                <span className="text-2xl font-black text-slate-900">{totalAdmins}</span>
                                <span className="text-xs text-emerald-600 font-medium">Dueños de empresa</span>
                            </div>
                        </div>
                        ...
                        <div className="bg-white rounded-2xl border border-slate-100 p-5 shadow-sm hover:shadow-md transition-shadow sm:col-span-2 lg:col-span-1">
                            <div className="flex items-center justify-between">
                                <span className="text-xs font-bold text-slate-400 uppercase tracking-wider">Empleados Operativos</span>
                            ...
                            <div className="flex items-baseline space-x-2 mt-3">
                                ...
                                <span className="text-xs text-slate-400">Usuarios del sistema</span>
                            </div>
                        </div>
                    </div>
                            ...
                            <div>
                                <div className="flex items-center justify-between border-b border-slate-50 pb-4 mb-4">
                                    ...
                                    <div className="flex items-center space-x-1.5">
                                        ...
                                        <span className="text-xs font-bold text-slate-500">Servidor Activo</span>
                                    </div>
                                </div>
